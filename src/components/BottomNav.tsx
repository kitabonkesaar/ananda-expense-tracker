...
import { LayoutDashboard, Map, Plus, Settings, Receipt } from 'lucide-react';
...
export default function BottomNav() {
  ...
  const displayedItems = (user?.role === 'staff' || user?.role === 'admin')
    ? navItems 
    : navItems.filter(item => item.to !== '/add-expense');
